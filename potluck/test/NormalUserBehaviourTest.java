 ...
 *
 */
public class NormalUserBehaviourTest {
	...
	//	/**
	//	 * Test method for {@link potluck.domain.NormalUserBehaviour#createRecipePrepare(potluck.domain.RecipeBuilder)}.
	//	 */
	//	@Test
	//	public final void testCreateRecipePrepare() {
...
//		/**
//		 * Test method for {@link potluck.domain.NormalUserBehaviour#createRecipe(potluck.domain.RecipeBuilder)}.
//		 */
//		@Test
//		public final void testCreateRecipe() {
//			normalBehaviour.addTags(builder, tags);
//			assertEquals(tags,builder.getTags());	
//		}
		/**
	...
	//
	//	/**
	//	 * Test method for {@link potluck.domain.NormalUserBehaviour#deleteComment(int)}.
	//	 */
	//	@Test
	...
	//
	//	/**
	//	 * Test method for {@link potluck.domain.NormalUserBehaviour#deleteRecipe(int)}.
	//	 */
	//	@Test
	...
	//
	//	/**
	//	 * Test method for {@link potluck.domain.NormalUserBehaviour#userBehaviour()}.
	//	 */
	//	@Test
	//	public final void testUserBehaviour() {
	//		fail("Not yet implemented"); // TODO
	//	}
